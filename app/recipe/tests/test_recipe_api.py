...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='bacon and eggs')
        recipe2 = sample_recipe(user=self.user, title='Steak and eggs')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Steak and eggs')
        recipe3 = sample_recipe(user=self.user, title='Vegetable curry')
        ingred1 = sample_Ingredients(user=self.user, name='Eggs')
        ingred2 = sample_Ingredients(user=self.user, name='Steak')
